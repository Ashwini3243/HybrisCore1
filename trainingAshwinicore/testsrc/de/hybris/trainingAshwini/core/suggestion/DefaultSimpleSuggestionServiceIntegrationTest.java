 ...
 */
package de.hybris.trainingAshwini.core.suggestion;
...
import de.hybris.trainingAshwini.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/trainingAshwinicore/test/testSimpleSuggestionService.csv", "utf-8");
	}
