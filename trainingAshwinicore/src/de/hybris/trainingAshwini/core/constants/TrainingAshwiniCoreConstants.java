 ...
 */
package de.hybris.trainingAshwini.core.constants;

/**
 * Global class for all TrainingAshwiniCore constants. You can add global constants for your extension into this class.
 */
public final class TrainingAshwiniCoreConstants extends GeneratedTrainingAshwiniCoreConstants
{
	public static final String EXTENSIONNAME = "trainingAshwinicore";


	private TrainingAshwiniCoreConstants()
	{
		//empty
	}
