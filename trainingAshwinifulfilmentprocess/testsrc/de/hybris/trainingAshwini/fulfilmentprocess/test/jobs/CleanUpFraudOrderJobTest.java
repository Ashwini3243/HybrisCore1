 ...
 */
package de.hybris.trainingAshwini.fulfilmentprocess.test.jobs;
...
import de.hybris.trainingAshwini.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = TrainingAshwiniFulfilmentProcessConstants.ORDER_PROCESS_NAME;
