...
import de.hybris.trainingAshwini.fulfilmentprocess.test.actions.TestActionTemp;
...
public class PaymentIntegrationTest extends ServicelayerTest
{
	...
	public static void prepare() throws Exception
	{
		...
		xmlReader.loadBeanDefinitions(
				new ClassPathResource("/trainingAshwinifulfilmentprocess/test/trainingAshwinifulfilmentprocess-spring-test.xml"));
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/trainingAshwinifulfilmentprocess/test/trainingAshwinifulfilmentprocess-spring-test-fraudcheck.xml"));
		xmlReader
				.loadBeanDefinitions(new ClassPathResource("/trainingAshwinifulfilmentprocess/test/process/order-process-spring.xml"));
		...
		definitonFactory.add("classpath:/trainingAshwinifulfilmentprocess/test/process/payment-process.xml");
	...
	public void setUpProductCatalogue()
	{
		try
		{
			...
			importCsv("/trainingAshwinifulfilmentprocess/test/testBasics.csv", "windows-1252");
			importCsv("/trainingAshwinifulfilmentprocess/test/testCatalog.csv", "windows-1252");
	...
	public static void removeProcessDefinitions()
	{
		...
		final XmlBeanDefinitionReader xmlReader = new XmlBeanDefinitionReader((BeanDefinitionRegistry) beanFactory);
		xmlReader.loadBeanDefinitions(
				new ClassPathResource("/trainingAshwinifulfilmentprocess/test/trainingAshwinifulfilmentprocess-spring-testcleanup.xml"));
