 ...
 */
package de.hybris.trainingAshwini.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(TrainingAshwiniFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(TrainingAshwiniFulfilmentProcessConstants.PARENT_PROCESS);
