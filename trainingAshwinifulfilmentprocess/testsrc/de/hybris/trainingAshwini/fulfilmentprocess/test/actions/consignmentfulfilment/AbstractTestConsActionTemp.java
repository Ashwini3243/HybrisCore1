 ...
 */
package de.hybris.trainingAshwini.fulfilmentprocess.test.actions.consignmentfulfilment;
...
public abstract class AbstractTestConsActionTemp extends TestActionTemp
{
	...
	{
		final String parentCode = (String) getProcessParameterValue(process, TrainingAshwiniFulfilmentProcessConstants.PARENT_PROCESS);
