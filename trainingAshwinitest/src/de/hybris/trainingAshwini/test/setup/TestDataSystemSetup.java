 ...
 */
package de.hybris.trainingAshwini.test.setup;
...
import de.hybris.trainingAshwini.test.constants.TrainingAshwiniTestConstants;
import de.hybris.trainingAshwini.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = TrainingAshwiniTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/trainingAshwinitest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/trainingAshwinitest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/trainingAshwinitest/import/cstickets.impex");
			...
			importImpexFile(context, "/trainingAshwinitest/import/csquotes.impex");
		}
	}
}
