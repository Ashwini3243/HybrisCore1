 ...
 */
package de.hybris.trainingAshwini.storefront.controllers;
	...
	interface Views
	{
		...
		interface Pages
		{
			interface ManufacturerDetails{
				String ManufacturerDetailsDataById="pages/customPages/manufacturerDetailsDataById";
			}
			...
			interface  ManuData
			{
				String ManuData="pages/customPages/manufacturerDetailsDataById";
				String ManuDataListWithPagination="pages/customPages/manufacturerDetailsListWithPagination";
				String ManuDataByIdAndName="pages/customPages/manufacturerDetailsByIdAndName";
				String pagination="pages/customPages/pagination";
				String displayManuDataForm="pages/customPages/manufacturerDetailsForm";
				String saveManuDataSuccessMsg="pages/customPages/saveManuDataSuccessMsg";
			}
			interface customCutsomer
			{
				String customCustomer="pages/customPages/customCustomerList";
			}
